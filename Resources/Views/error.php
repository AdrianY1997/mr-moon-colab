<div class="error foxy-container foxy-flex foxy-justify-between">
    <div class="w-100">
        <div>
    ...
    <div class="foxy-self-center w-100">
        <div><?= $code ?></div>
        <div>UH OH! You're lost.</div>
        <div><?= $subtitle ?></div>
        <div><a href="<?= route(constant("HOME")) ?>">HOME</a></div>
    </div>
</div>