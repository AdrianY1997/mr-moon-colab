        ...
        <div class="container">
            <div class="auth-form">
                ...
                <form action="{{ route('user.star') }}" method="POST">
                    ...
                    <div class="form-control mb-3">
                        <input class="py-0" style="margin-bottom: 1px" type="text" name="lastname" id="lastname"
                            placeholder="lastname">
                        <label for="lastname">Apellido</label>
                    </div>
                    <div class="form-control mb-3">
                        <input class="py-0" style="margin-bottom: 1px" type="text" name="email" id="email"
                            placeholder="email">
                        <label for="email">Email</label>
                    </div>
                    <div class="form-control mb-3">
                        <input class="py-0" style="margin-bottom: 1px" type="text" name="password" id="password"
