                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="Admin"
                                class="rounded-circle border" width="150">
                            <div class="mt-3">
                                <h4>
                                    <?php if ($user->user_nick) { ?>
                                    <p><?= $user->user_nick ?></p>
                                    <?php } else { ?>
                                    <p>Sin Especificar</p>
                                    <?php } ?>
                                ...
                                <a href="<?= route('auth.close') ?>"><button class="btn btn-outline-danger">Cerrar
                                        Sesión</button></a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-floating">
                                                <input name="nick" id="nick" type="text" class="form-control"
                                                    placeholder="John Doe" value="<?php if($user->user_nick) { echo $user->user_nick; } ?>">
                                        ...
                                        <div>
                                            <div class="form-floating">
                                                <input class="form-control border shadow fs-6" data-bs-toggle="tooltip"
                                                    ...
                                                    data-bs-title="La nueva contraseña debe contener entre 8 y 16 caracteres, 1 letra mayúscula y un carácter especial"
                                                    style="margin-bottom: 1px" type="password" name="new-pass"
                                                    id="new-pass" placeholder="password">
                                    ...
                                    <div class="row mx-1 mb-3">
                                        <div class="form-floating p-0">
                                            <input name="name" id="name" type="text" class="form-control"
                                                placeholder="John" value="<?php if($user->user_name) { echo $user->user_name; } ?>">
                                    ...
                                    <div class="row mx-1 mb-3">
                                        <div class="form-floating p-0">
                                            <input name="lastname" id="lastname" type="text"
                                                class="form-control" placeholder="Doe" value="<?php if($user->user_lastname) { echo $user->user_lastname; } ?>">
                                    ...
                                    <div class="row mx-1 mb-3">
                                        <div class="form-floating p-0">
                                            <input name="email" id="email" type="text" class="form-control"
                                                placeholder="mail@domain.com" value="<?php if($user->user_email) { echo $user->user_email; } ?>" readonly>
                                    ...
                                    <div class="row mx-1 mb-3">
                                        <div class="form-floating p-0">
                                            <input name="address" id="address" type="text" class="form-control"
                                                placeholder="mail@domain.com" value="<?php if($user->user_address) { echo $user->user_address; } ?>">
                                    ...
                                    <div class="row mx-1 mb-3">
                                        <div class="form-floating p-0">
                                            <input name="phone" id="phone" type="text" maxlength="10"
                                                ...
                                                value="<?php if($user->user_phone) { echo $user->user_phone; } ?>">
