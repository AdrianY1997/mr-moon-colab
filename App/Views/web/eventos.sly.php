<div class="event">
    ...
    <div class="imgs container position-relative p-0">
        ...
        <div class="evento-item" data-event-href="<?= route('event.get', ['id' => $evento->even_id]) ?>" type="button"
            ...
            <div class="detalles"><button type="button" class="btn btn-primary" style="width: fit-content"
                    aria-label="Close">Ver Detalles</button></div>
        </div>
        <?php }} ?>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="text-center mb-4">
                <button type="button" class="btn btn-primary alpha" style="width: fit-content" data-bs-dismiss="modal"
