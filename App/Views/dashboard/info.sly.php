        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <form class="set-info hide" data-section="1" method="post" action="{{ route("dash.info.update") }}" enctype="multipart/form-data">
                    ...
                    <div class="web-data">
                        ...
                        <div>
                            <div class="position-relative d-flex mb-2">
                                <label class="form-label bg-body-secondary rounded-start-2 p-2 m-0"><i class="fa-solid fa-file-signature"></i></label>
                                <input class="ps-2 form-control border-start-0 rounded-0 rounded-end-2" name="name" type="text" value="{{ $webdata->webd_name }}">
                            </div>
                            <div class="position-relative d-flex mb-2">
                    ...
                    <p class="m-0">Datos de contacto</p>
                    <div class="position-relative d-flex mb-2">
                        <label class="form-label bg-body-secondary rounded-start-2 p-2 m-0"><i class="fa-solid fa-at"></i></label>
                        <input class="ps-2 form-control border-start-0 rounded-0 rounded-end-2" name="email" type="text" value="{{ $webdata->webd_email }}">
                    </div>
                    <div class="position-relative d-flex mb-2">
                        <label class="form-label bg-body-secondary rounded-start-2 p-2 m-0"><i class="fa-solid fa-phone"></i></label>
                        <input class="ps-2 form-control border-start-0 rounded-0 rounded-end-2" name="phone" type="text" value="{{ $webdata->webd_phone }}">
                    </div>
                    <div class="position-relative d-flex mb-2">
                        <label class="form-label bg-body-secondary rounded-start-2 p-2 m-0"><i class="fa-solid fa-location-dot"></i></label>
                        <input class="ps-2 form-control border-start-0 rounded-0 rounded-end-2" name="address" type="text" value="{{ $webdata->webd_address }}">
                    </div>
                    <div class="position-relative d-flex mb-2">
                        <label class="form-label bg-body-secondary rounded-start-2 p-2 m-0"><i class="fa-solid fa-earth-americas"></i></label>
                        <input class="ps-2 form-control border-start-0 rounded-0 rounded-end-2" name="city" type="text" value="{{ $webdata->webd_city }}">
                    </div>
                    <hr>
                    <p class="m-0">Redes sociales</p>
                    <div class="position-relative d-flex mb-2">
                        <label class="form-label bg-body-secondary rounded-start-2 p-2 m-0"><i class="fa-brands fa-facebook"></i></label>
                        <input class="ps-2 form-control border-start-0 rounded-0 rounded-end-2" name="fblink" type="text" value="{{ $webdata->webd_fblink }}">
                    </div>
                    <div class="position-relative d-flex mb-2">
                        <label class="form-label bg-body-secondary rounded-start-2 p-2 m-0"><i class="fa-brands fa-twitter"></i></label>
                        <input class="ps-2 form-control border-start-0 rounded-0 rounded-end-2" name="twlink" type="text" value="{{ $webdata->webd_twlink }}">
                    </div>
                    <div class="position-relative d-flex mb-2">
                        <label class="form-label bg-body-secondary rounded-start-2 p-2 m-0"><i class="fa-brands fa-instagram"></i></label>
                        <input class="ps-2 form-control border-start-0 rounded-0 rounded-end-2" name="iglink" type="text" value="{{ $webdata->webd_iglink }}">
                    </div>
                    <div class="position-relative d-flex mb-2">
                        <label class="form-label bg-body-secondary rounded-start-2 p-2 m-0"><i class="fa-brands fa-youtube"></i></label>
                        <input class="ps-2 form-control border-start-0 rounded-0 rounded-end-2" name="ytlink" type="text" value="{{ $webdata->webd_ytlink }}">
                    </div>
                    <hr>
                    <div>
                        <div class="reverse">
                            <div class="position-relative d-flex mb-2">
                                <label class="form-label bg-body-secondary rounded-start-2 p-2 m-0"><i class="fa-solid fa-key"></i></label>
                                <input class="ps-2 form-control border-start-0 rounded-0 rounded-end-2" name="password" type="password" placeholder="Contraseña">
                            </div>
                            <div>
