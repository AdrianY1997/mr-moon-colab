            ...
            <div class="content position-relative">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr class="item" data-href="{{ route("dash.itemGetInfo", ["id" => $Event->even_id]) }}">
                ...
                <div id="modal-edit" class="modal position-absolute p-3 bg-black bg-opacity-10" style="z-index: 1">
                    <div class="position-absolute top-50 start-50 translate-middle bg-white rounded-2 p-3 w-100 h-100 p-3">
                        ...
                        <form action="{{ route("even.edit") }}" method="post">
                            ...
                            <div class="form-label-group mb-3">
                                <label for="even-edit-name">Descripción</label>
                                <textarea type="text" id="even-edit-text" name="even-edit-text" placeholder=""></textarea>
                            </div>
                            <div class="form-label-group mb-3">
                                <label for="even-edit-name">Fecha</label>
                                <textarea type="text" id="even-edit-fech" name="even-edit-fech" placeholder=""></textarea>
                            </div>
                            <div class="d-flex justify-content-between">
