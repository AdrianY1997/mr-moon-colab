        ...
        <div class="container">
            ...
            <div class="content d-flex gap-3">
                <div class="dash-menu-item-container" data-img="main">
                    ...
                    <form action="<?= route('dash.menuSetImg', ['id' => 2]) ?>" method="post" class="d-none"
                ...
                <div class="dash-menu-item-container" data-img="drink">
                    ...
                    <form action="<?= route('dash.menuSetImg', ['id' => 1]) ?>" method="post" class="d-none"
                        enctype="multipart/form-data">
                        <input class="menu-img" name="menu-img" type="file">
                    </form>
                </div>
                <div class="dash-menu-item-container" data-img="food">
                    ...
                    <form action="<?= route('dash.menuSetImg', ['id' => 3]) ?>" method="post" class="d-none"
                        enctype="multipart/form-data">
                        <input class="menu-img" name="menu-img" type="file">
                    </form>
                </div>
