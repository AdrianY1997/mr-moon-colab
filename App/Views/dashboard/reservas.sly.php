...
<div class="dash dash-reservas">
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="mb-3 position-relative">
                    <button
                        class="d-flex align-items-center border-0 border-dark bg-dark text-white shadow px-1 rounded-2"
                        data-bs-target="#reserve-status" data-bs-toggle="collapse" role="button">
                        <span
                            class="d-flex justify-content-center align-items-center bg-white text-dark py-1 px-2 rounded-start-1">
                    ...
                    <div class="position-absolute collapse top-100 fade bg-white shadow mt-1" id="reserve-status">
                        <p data-hash="status="
                            class="m-0 d-flex align-items-center px-1 btn p-1 border-start border-end rounded-0 border-2"
                            style="border-color: transparent; --color: var(--bs-secondary-rgb)">
                        ...
                        <p data-hash="status=<?= Reservation::WAITING_FOR_PAYMENT ?>-waiting-payment"
                            class="m-0 d-flex align-items-center px-1 btn p-1 border-start border-end rounded-0 border-2"
                            style="border-color: transparent; --color: var(--bs-warning-rgb)">
                            <span class="d-flex justify-content-center align-items-center py-1 px-2 text-warning">
                        ...
                        <p data-hash="status=<?= Reservation::WAITING_FOR_CONFIRMATION ?>-waiting-confirmation"
                            class="m-0 d-flex align-items-center px-1 btn p-1 border-start border-end rounded-0 border-2"
                            style="border-color: transparent; --color: var(--bs-primary-rgb)">
                        ...
                        <p data-hash="status=<?= Reservation::RESERVED ?>-reserved"
                            class="m-0 d-flex align-items-center px-1 btn p-1 border-start border-end rounded-0 border-2"
                            style="border-color: transparent; --color: var(--bs-success-rgb)">
                        ...
                        <p data-hash="status=<?= Reservation::CANCELLED ?>-cancelled"
                            class="m-0 d-flex align-items-center px-1 btn p-1 border-start border-end rounded-0 border-2"
                            style="border-color: transparent; --color: var(--bs-danger-rgb)">
    ...
    <div class="modal fade" id="reservation-modal" tabindex="-1" aria-labelledby="reservation-label"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body text-start text-black p-4">
                    <div class="modal-title text-uppercase mb-2">
                        <img class="w-100" src="Public\img\facturas\16915973922-1691597057-164d3b901ec0da.png"
                            data-root="<?= constant('BASE_URL') ?>" alt="" data-reservation-image>
                    </div>
                ...
                <div class="p-4 modal-footer border-top-0 pt-2">
                    <button type="button" class="btn btn-success disabled" style="width: fit-content"
                        id="confirm-payment" data-href="<?= route('dash.reserve.confirm.payment') ?>">Confirmar
                        Pago</button>
                    <button type="button" class="btn btn-danger" style="width: fit-content" id="cancel-payment"
                        data-href="<?= route('dash.reserve.cancel.payment') ?>">Rechazar Pago</button>
                    <button type="button" class="btn btn-outline-danger" style="width: fit-content"
