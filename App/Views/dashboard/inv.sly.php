                    ...
                    <tbody>
                        ...
                        <tr class="item" data-href="<?= route('dash.itemGetInfo', ['id' => $product->prod_id]) ?>">
                            ...
                            <td class="d-flex gap-2">
                                ...
                                <a href="<?= route('inv.delete', ['id' => $product->prod_id]) ?>"
                    ...
                    <div
                        ...
                        <form action="<?= route('inv.edit') ?>" method="post">
                            ...
                            <div class="form-label-group mb-3">
                                ...
                                <select name="item-edit-prov" id="item-edit-prov"
                                    data-get-prov="<?= route('dash.getProv') ?>">
                                    <option selected disabled>Cargando...</option>
                                </select>
                            </div>
                            <div class="form-label-group mb-3">
                            ...
                            <div class="d-flex w-100 gap-3 mb-3">
                                <div class="form-label-group">
                                    ...
                                    <input type="number" min="1" id="item-edit-stock"
                                        name="item-edit-stock">
                                </div>
                                <div class="form-label-group">
                                    <label for="item-edit-value">Valor</label>
                                    <input type="number" min="1" id="item-edit-value"
                                        name="item-edit-value">
                                </div>
                            </div>
                            <div class="d-flex justify-content-between">
