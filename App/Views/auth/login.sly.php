                ...
                <div class="auth-form">
                    ...
                    <form action="<?= route('auth.start') ?>" method="POST">
                        <div class="form-floating mb-3">
                            <input class="form-control border shadow fs-6" style="margin-bottom: 1px" type="text"
                                name="email" id="email" placeholder="email">
                            <label for="email">Email</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control border shadow fs-6" style="margin-bottom: 1px" type="password"
                    ...
                    <p class="m-0">¿Olvidaste tu contraseña? Click <a href="<?= route('auth.recovery') ?>">aquí</a>
                    </p>
                </div>
